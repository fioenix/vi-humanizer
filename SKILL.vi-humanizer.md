...
2. Quét lõi V1–V20, rồi profile, rồi typography T1–T6.
3. Viết bản nháp.
...
5. Viết bản cuối.
6. **Soi lại chính bản sửa của mình.** Mỗi pattern đều bảo bạn bỏ một thứ rồi thay bằng thứ khác, mà thứ thay vào thường là một danh sách ngắn. Chọn mãi một mục trong danh sách thì bạn vừa xoá một tell vừa dựng lên một tell mới: sự đồng nhất. Đếm từ thay thế bạn dùng nhiều nhất, so với các lựa chọn còn lại. Lệch hẳn về một phía là dấu hiệu chữa quá tay, quay lại trộn cho đều.
...
**Anh em với V20:** V1 rụng bổ ngữ sau động từ, V20 rụng nửa sau của từ ghép. Cùng một lỗi dịch phần đầu rồi dừng.
...
### V20. Từ ghép bị cắt còn một âm tiết

**Dấu hiệu:** một âm tiết đứng đơn ở chỗ nghĩa đang dùng đòi phải có thành tố thứ hai. Hai dạng, dạng sau khó thấy hơn nhiều.
(a) Âm tiết vốn không đứng đơn được: *rườm* (rườm rà), *chới* (chới với), *bỡ* (bỡ ngỡ), *khả* (khả quan), *lấn* (lấn cấn).
(b) Âm tiết đứng đơn được **nhưng mang nghĩa khác**: *"đọc lên thấy hụt"*. Chữ *hụt* đứng đơn chỉ sự thiếu về lượng (*hụt tiền*, *hụt hơi*), còn nghĩa chới với hẫng hụt thì phải là *hụt hẫng*.
**Vì sao:** cùng cơ chế với V1, chỉ khác vị trí. Tiếng Anh gói cả nghĩa vào một từ (*off*, *short*, *awkward*), model ánh xạ sang âm tiết gần nhất rồi dừng, không sinh nốt thành tố thứ hai. V1 rụng bổ ngữ sau động từ, V2 rụng nửa sau của từ ghép. Người Việt đọc lên thấy tai còn chờ một âm tiết nữa.
**Sửa:** *"Câu này đúng ngữ pháp nhưng đọc lên thấy hụt"* → *"...thấy **hụt hẫng**"*. *"Quy trình còn rườm"* → *"còn **rườm rà**"*. Test bằng tai: đọc to, chỗ nào nhịp bị treo giữa chừng thì chỗ đó thiếu âm tiết. Test bằng nghĩa: âm tiết này đứng đơn có nghĩa khác không? Có thì phải ghép.
**Không flag:** từ đơn hợp lệ đúng nghĩa (*đi, ăn, vui, buồn, đẹp, sạch*), đây là đa số và không được đụng vào. Từ láy mà thành tố đầu đứng đơn tốt (*đẹp* so với *đẹp đẽ*, *sạch* so với *sạch sẽ*): thêm thành tố hai là lựa chọn phong cách, không phải chữa lỗi. Thuật ngữ kỹ thuật rút gọn theo quy ước ngành. Văn phong tối giản có chủ ý.
...
**Sửa:** loại (a) bỏ dấu phẩy: *"báo cáo tài chính, kế hoạch nhân sự, và lịch triển khai"* → *"báo cáo tài chính, kế hoạch nhân sự và lịch triển khai"*. Loại (b) chọn hư từ theo quan hệ:

| Quan hệ | Hư từ | Ghi chú chọn từ |
|---|---|---|
| Nhân quả | *nên* | *"viết lại chứ không phải chữa, nên nguy cơ bịa tăng vọt"* |
| Tương phản | **nhưng** (mặc định) | Đây là liên từ đối lập chuẩn của văn viết. Chọn nó trước, trừ khi có lý do cụ thể để chọn khác |
| Tương phản gắn chặt, hai vế chung chủ thể, giọng gần khẩu ngữ | *mà* | *"đó là văn khô, mà văn khô không phải lỗi"*. Hẹp hơn *nhưng* nhiều |
| Đối lập cục bộ, đổi chủ đề | *còn... thì* | *"phân tầng bằng hư từ, còn bôi đậm thì rất tiết kiệm"* |
| Nối tiếp | *rồi* | Hai việc xảy ra theo thứ tự |

**Phanh over-correction:** danh sách trên là chỗ dễ hỏng nhất của cả T4. Bản vá v0.2.2 nêu *mà* mà bỏ sót *nhưng*, hậu quả là agent gom mọi quan hệ tương phản về *mà* và tạo ra một tell mới. Sau khi sửa xong, **đếm lại**: trong văn xuôi không bàn về chính chữ *mà*, nếu *mà* nhiều hơn *nhưng* thì bạn đã chữa quá tay. Dấu chấm phẩy nối mệnh đề xử lý cùng cách.
...
- **Tỉ lệ giữa các lựa chọn thay thế.** Không chỉ đếm tổng, hãy đếm cả phân bố. Liên từ đối lập: *nhưng* phải nhiều hơn *mà* trong văn viết. Trạng từ nối: đừng dùng đi dùng lại một từ. Bổ ngữ kết quả: *được* dễ bị lạm dụng hơn *ra, thấy, xong, hết, nổi*. Một danh sách thay thế mà bạn chỉ dùng mục đầu tiên thì nó không còn là danh sách.
