...
| nghe tiếng động | nghe **thấy** tiếng động | hear (vs. listen) |
| nhìn con mèo | nhìn **thấy** con mèo | see (vs. look) |
| đọc toàn bộ tài liệu | đọc **hết** tài liệu | read through |
| làm bài tập (đã xong) | làm **xong** bài tập | finish |
| nhớ tên anh ấy | nhớ **ra** tên anh ấy | recall |
| hiểu ý bạn | hiểu **được** ý bạn | understand, get |
| không chịu áp lực | không chịu **nổi** áp lực | cannot stand |
| tiêu tiền | tiêu **mất** tiền | spend, lose |
| nghĩ cách | nghĩ **ra** cách | figure out |

**Chọn bổ ngữ theo loại kết quả:**
...
| Nếu, Giá mà, Hễ, Chỉ cần | thì, là |
| Càng | càng |
| Không những, Chẳng những | mà còn |
| Để | thì |
| Vừa | vừa |
| Bao nhiêu | bấy nhiêu |
...
|---|---|---|
| con | động vật, một số vật chuyển động hoặc có "sức sống" | con mèo, con dao, con đường, con số, con thuyền |
| chiếc | phương tiện, vật dụng dùng riêng lẻ | chiếc xe, chiếc áo, chiếc đũa, chiếc điện thoại |
| cái | đồ vật vô tri nói chung | cái bàn, cái cốc, cái máy tính |
| bức, tấm | vật phẳng | bức tranh, bức tường, tấm ảnh, tấm bảng |
| quyển, cuốn | sách vở | quyển sách, cuốn sổ |
| tờ | giấy, vật mỏng | tờ giấy, tờ báo, tờ trình |
| cây | vật dài | cây bút, cây cầu, cây xăng |
| ngôi | nhà cửa, công trình, sao | ngôi nhà, ngôi trường, ngôi sao |
| người, vị, ngài | người, phân theo mức trang trọng | người khách, vị giám đốc |

**Ba câu hỏi cho mỗi danh từ:**

1. Nó chỉ vật thể cụ thể đếm được không?
2. Trong ngữ cảnh này nó trỏ một cá thể xác định, hay đang nói khái quát về cả loại?
3. Trước nó đã có số đếm hoặc từ chỉ định chưa?
...
|---|---|
| nhé | khuyên hoặc nhờ nhẹ |
| đấy, chứ | khẳng định có sức thuyết phục |
| thôi, nào | rủ cùng làm |
| nhỉ | hỏi lại tìm đồng tình |
| ạ | kính trọng |
| à, ư, hả | hỏi xác nhận |
| mà | phản bác nhẹ, nhắc lại điều đã nói |
| cơ | nhấn mạnh mong muốn hoặc trái ý |
| vậy | chấp nhận, xuôi theo |
| rồi | hoàn tất, đồng thời hoạt động như tiểu từ |
...
## Khung hỏi và khung cầu khiến (V6)

**Khung hỏi:**

| Loại câu hỏi | Khung tiếng Việt |
|---|---|
| Hỏi thông tin | từ để hỏi: ai, gì, nào, đâu, sao, bao giờ, bao nhiêu |
| Hỏi có hay không | có ... không |
| Hỏi đã xảy ra chưa | đã ... chưa, hoặc rút gọn còn "... chưa" |
| Hỏi xác nhận | ... phải không, ... đúng không, ... à, ... nhỉ |
...
|---|---|
| hãy | trang trọng, hơi cứng, dùng tiết chế |
| cứ | khuyến khích |
| đi | thân, hơi giục |
| nhé | nhẹ, lịch sự |
| giúp, hộ, với | nhờ vả |
